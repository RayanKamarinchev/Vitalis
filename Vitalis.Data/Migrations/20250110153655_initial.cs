    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    TestId = table.Column<Guid>(type: "uuid", nullable: false),
                    TestTakerId = table.Column<string>(type: "text", nullable: false),
                    Score = table.Column<float>(type: "real", nullable: false),
                    TakenOn = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TestResults", x => new { x.TestId, x.TestTakerId });
                    table.ForeignKey(
                        name: "FK_TestResults_AspNetUsers_TestTakerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClosedQuestionAnswers_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClosedQuestionAnswers_UserId",
                table: "ClosedQuestionAnswers",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TestResults_TestTakerId",
                table: "TestResults",
                column: "TestTakerId");
